...
<div class="bgimg-1 w3-opacity w3-display-container">
  <div class="w3-display-middle" style="white-space:nowrap;">
    <span class="w3-center w3-padding-xlarge w3-black w3-xlarge w3-wide w3-animate-opacity">PURCHASE<span class="w3-hide-small"> BOOK</span> </span>
  </div>
</div>
   ...
   <li class="w3-padding-large">
    ...
    <li class="w3-padding-large">
   		<p>
  			...
  			<input class="w3-input-group w3-input" style="width:70px" type="password" name="cvv" placeholder="CVV" required pattern="[0-9]{3}" maxlength="3">
  		</p>
