...
<div class="w3-row w3-padding-32 w3-section">
  ...
  <li class="w3-padding-xlarge w3-center"><a href="bookroom.php" style="text-decoration: none">View Books</a></li>
  <li class="w3-padding-xlarge w3-center w3-deep-purple"><a href="bookedhistory.php" style="text-decoration: none">Books History</a></li>
    ...
    <h1><p class="w3-center w3-text-black">Your purchase history, <?php echo $_SESSION['pat_name']; ?></h1></p>
  ...
  <?php 
    ...
    while($row=mysqli_fetch_assoc($result)) 
     {    
      ...
      $link = "SELECT link from reservation where book_name='$book_name' ";
      $resultlink = $mysqli->query($link);
  
      while($row=mysqli_fetch_assoc($resultlink))
      {
        print '<td><a href="'.$row['link'].'">View PDF</a></td>';
      }
      echo '</tr>';
     }
  ?>
