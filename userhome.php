...
<div class="w3-row w3-padding-32 w3-section">
  ...
  <li class="w3-padding-xlarge w3-center"><a href="gallery.php" style="text-decoration: none">Gallery</a>
  ...
  <li class="w3-padding-xlarge w3-center"><a href="bookedhistory.php" style="text-decoration: none">Books History</a></li>
  	...
  	<h1><p class="w3-center w3-text-black">Welcome, <?php echo $_SESSION['pat_name']; ?></h1></p>
  	<p class="w3-center"><em>Didn't read a book yet? Head on to GALLERY and see best books !!!<em></p>
  	</div>
   </div>      
