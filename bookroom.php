...
<div class="w3-row w3-padding-32 w3-section">
  ...
  <li class="w3-padding-xlarge w3-center"><a href="gallery.php" style="text-decoration: none">Gallery</a></li>
  ...
  <div class="w3-col m4 w3-container w3-section">
	...
	<form name ="book" method="post" action="bookroom1.php">
    
      <p><b>Genre:</b><br>
          <input  type="radio" name="genre" value="Comics">Comics<br>
	...
	<?php
	$select_query = "Select book_name from book_details";
   ...
   <!--li class="w3-padding-large">
   		 <p><b>Date:</b><br>
        		<input id="txtFromDate" type="date" name="Date"><br>	
      </p>
    </li>-->
