	...
	if($_SERVER["REQUEST_METHOD"] == "POST")
	{
      ...
      $result = $mysqli->query($sql) or die("BOOM");
      	...
      	if ($result->num_rows == 1) 
      	{
      		...
      		$_SESSION['pat_name']=$cust['user_name'];
         	$_SESSION['email'] = $email;
         	$_SESSION['pat_id'] = $cust['user_id'];
         	echo "Logged in!";	
      	...
      	else 
      	{
         	echo '<script language="javascript">';
			    echo 'alert("Email or Password entered is invalid. Please try again. OR Sign Up with us")';
			    echo '</script>';
   		}	
   }
?>
...
<div class="w3-top">
  <ul class="w3-navbar w3-text-white" id="myNavbar">
    ...
    <li><a href="signup.php" class="w3-padding-large"><b>SIGN UP</b></a></li>
  </ul>
</div>
  ...
  <div class="w3-row w3-padding-32 w3-section">
    ...
    <img src="images/logo.png" height="50px">
      <div class="w3-large w3-margin-bottom">
        ...
        <p><input class="w3-input-group w3-input w3-animate-input" type="name" name="email" placeholder="Email" required><br>
        </p>
